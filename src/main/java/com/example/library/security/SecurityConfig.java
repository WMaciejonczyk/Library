                ...
                .authorizeHttpRequests(
                        authorizationManagerRequestMatcherRegistry ->
                                authorizationManagerRequestMatcherRegistry
                                        ...
                                        .requestMatchers("book/getByAuthor").permitAll()
                                        .requestMatchers("book/getByIsbn").permitAll()
                                        .requestMatchers("book/getByTitle").permitAll()
                                        .requestMatchers("review/**").permitAll()
                                        .requestMatchers("rental/showHistory").permitAll()
